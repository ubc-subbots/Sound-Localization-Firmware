...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sdram_clock_0_sys_pll.vo"                    -work sys_pll           -cdslib ./cds_libs/sys_pll.cds.lib          
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sdram_clock_0.v"                             -work clock_0           -cdslib ./cds_libs/clock_0.cds.lib          
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sdram_SDRAM.v"                               -work SDRAM             -cdslib ./cds_libs/SDRAM.cds.lib            
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/sdram_SDRAM_test_component.v"                -work SDRAM             -cdslib ./cds_libs/SDRAM.cds.lib            
